...
import { endWildGame, getWildEncounterState, getWildMatchState, getWildRoomState, publishWildMission, startWildGame, type WildEncounterState, type WildMatchState, type WildRoomState } from "@/lib/wild";
...
export default function WildHostManager({ roomId, roomEnded = false }: { roomId: string; roomEnded?: boolean }) {
  ...
  const [verification, setVerification] = useState<"none" | "same_faction" | "different_faction" | "specific_faction" | "memory_upload" | "match_faction">("none");
